...
SYSTEM_TEST_ENG_MESSAGE = SystemMessage(f"""
            ...
            Parse these manual test cases into JSON format.
            Extract: test_id, steps (as list), expected_result, UI components mentioned
            """)
